...
public class ProdutoController {
	...
	public ResponseEntity<Object> getByNomeOuLaboratorio(@PathVariable String nome, @PathVariable String laboratorio){
	...
	public ResponseEntity<Object> getByNomeELaboratorio(@PathVariable String nome, @PathVariable String laboratorio){
